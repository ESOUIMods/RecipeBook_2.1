...
function RB.FillBank(last)--Main function that goes over the table and fills the row with data
    ...
    if #RB.BankValueTable<4 then
        ...
        if RB.BankValueTable[i].name == "Porky Port" then
            d("Porky Port Recipe Is Not Currently Supported By Recipebook.Breaking Now...")
            d("It was not possible for me to test this as I dont have the recipe,")
            d("If this Fix Breaks RB Please Report ASAP ON ESOUI.com")
            d("If the Fix Works Please Report ASAP ON ESOUI.com To Get This Message Removed. In Next Version.")
            break
        end
        ...
        if RB.BankValueTable[last].name == "Porky Port" then
            d("Porky Port Recipe Is Not Currently Supported By Recipebook.Breaking Now...")
            d("It was not possible for me to test this as I dont have the recipe,")
            d("If this Fix Breaks RB Please Report ASAP ON ESOUI.com")
            d("If the Fix Works Please Report ASAP ON ESOUI.com To Get This Message Removed. In Next Version.")
